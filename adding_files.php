...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/adding_files.css">
...
<body>
    ...
    <main>
        ...
        <div id="div_file_information">
            ...
            <input type="text" id="main_input_description" placeholder="Add a description">
            <input type="text" id="main_input" placeholder="Add a tags">
            ...
            <div id="div_file_information_end">
                ...
                <input type="checkbox" id="checkbox_file_information_end">
